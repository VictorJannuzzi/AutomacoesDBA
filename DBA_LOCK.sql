...
BEGIN  
 ...
 BEGIN  
  UPDATE #RESULT SET SESSION_RAIZ = (SELECT SESSION_RAIZ FROM #RESULT WHERE SESSION_ID = (SELECT DISTINCT blocking_session_id FROM #RESULT WHERE SESSION_RAIZ = 0 AND session_id = @ID)) WHERE SESSION_RAIZ = 0
 END  
